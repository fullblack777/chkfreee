	...
	<div class="container text-white rounded shadow p-3 my-4" style="background: #232b4a;">
		...
		<div class="container-fluid mt-3">
			<div class="buttons">
				...
				<!--<button class="btn btn-dark" style="background: #0d0e24;" onclick="window.location.href = './itaufast.php'"><i class="fas fa-link"></i> ITAÚ FAST </button>-->
			</div>
		</div>
		<!-- status do checker -->
		<div class="container-fluid mt-3">
	...
	<div class="container p-0 shadow">
		...
		<div class="tab-content" id="myTabContent">
			...
			<div class="tab-pane fade show active px-3 pt-4 pb-3" id="chk-home" role="tabpanel" aria-labelledby="home-tab">
				...
				<!--</div>-->
				<div class="container-fluid p-0 mt-2">
					<input type="text" id="cookie-input-2" placeholder="INSIRA COOKIE : AMAZON.COM [ WALLET ]" class="cookie-input rounded shadow">
				</div>
				<div class="container-fluid p-0 mt-2">
